<div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <!-- Dark mode light mode toggle here -->
                    <button
                        id="theme-toggle"
                        type="button"
                        title="Toggle dark mode"
                        class="relative w-10 h-10 flex items-center justify-center rounded-full text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 transition-all duration-200">
        ...
        <div class="h-full flex flex-col">
            ...
            <div class="flex-1 px-4 pb-4 overflow-y-auto">
                <ul class="space-y-1 font-medium">
                    ...
                    <!-- Profile -->
                    <li>
                        <a href="{{ route('learners.edit', auth()->user()->uuid) }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 transform hover:scale-[1.01] transition-all">
                            <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('training_student_batch_attendances.index') }}"
                            ...
                            <span class="ml-3 text-sm">My Training Batches</span>
                        </a>
                    </li>
                    @endif
    ...
    {{-- Place this before </body> or in a @push('scripts') stack --}}
    <script>
