        ...
        <div class="flex flex-col sm:flex-row flex-wrap items-center justify-between pb-4 space-y-4 sm:space-y-0">
            <div>
                <a href="{{ route('training_batch_schedule_items.create') }}"
                    ...
                    Create New Batch Training Schedule Item
                </a>
            </div>
                            ...
                            <td class="px-4 py-4">
                                <div class="space-y-1">
                                    <div class="flex items-center gap-2">
                                        <span class="font-bold text-gray-900 dark:text-white">{{ $trainingBatchScheduleItem->batch_name }}</span>
                                        <span class="px-2 py-0.5 text-xs font-medium text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">
                            ...
                            <td colspan="7" class="text-center text-gray-500 dark:text-gray-300">
                                <div class="bg-white dark:bg-gray-800 dark:border-gray-700">
                                    <div class="text-center py-4">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-500 dark:text-white">No training batch schedule item found</h3>
                                    </div>
                                </div>
                            </td>
                        </tr>
