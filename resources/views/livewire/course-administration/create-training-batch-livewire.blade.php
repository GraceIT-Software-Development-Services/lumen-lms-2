    ...
    <div class="max-w-full mx-auto">
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('batchCode') }}"
                            class="bg-gray-50 border @error('batchCode') border-red-500 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="bg-gray-50 border @error('batchName') border-red-500 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="bg-gray-50 border @error('startDate') border-red-500 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        @error('startDate')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <div>
                    <label for="trainer_id" class="block mb-2 text-sm font-medium text-gray-900">
                        Assigned Schedule <span class="text-red-600">*</span>
                    </label>
                    <select
                        id="training_schedule_item_id"
                        wire:model.live="trainingBatchScheduleId"
                        class="bg-gray-50 border @error('trainingBatchScheduleId') border-red-500 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <div>
                    <label for="trainer_id" class="block mb-2 text-sm font-medium text-gray-900">
                        Assigned Trainer <span class="text-red-600">*</span>
                    </label>
                    <select
                        id="trainer_id"
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        {{ $isConflict ? 'border-red-300 bg-red-50' : 'border-green-200 bg-gray-50' }}">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                {{ $isConflict ? 'border-red-500' : 'border-indigo-500' }}">
                                    <div class="h-2 w-2 rounded-full {{ $isConflict ? 'bg-red-500' : 'bg-green-500' }}">
                                    </div>
                                </div>
            ...
            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 gap-3">
                ...
                <a href="{{ route('training_batches.index') }}"
                    class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    Cancel
                </a>
            </div>
        </div>
