<div class="mx-auto max-w-full space-y-5">
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                            Fill in the course, schedule, trainer, and batch details.
                        </p>
                    </div>
                </div>
        ...
        <div wire:loading wire:target="trainingBatchCourseId,startDate,endDate,trainingBatchScheduleId,trainingBatchTrainerId,saveTrainingBatch" class="h-1 w-full overflow-hidden bg-blue-50 dark:bg-blue-950/40">
        ...
        <form wire:submit.prevent="saveTrainingBatch">
            <div class="space-y-0">
                ...
                <section class="border-b border-slate-100 px-5 py-6 dark:border-slate-800">
                    <div class="mb-5 flex items-start gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-slate-950 dark:text-white">Basic Information</h2>
                            <p class="text-sm text-slate-500 dark:text-slate-400">Training course, batch details, dates, and capacity.</p>
                        </div>
                    </div>
                ...
                <section class="border-b border-slate-100 px-5 py-6 dark:border-slate-800">
                    <div class="mb-5 flex items-start gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-slate-950 dark:text-white">Batch Schedule Information</h2>
                            <p class="text-sm text-slate-500 dark:text-slate-400">Assign a schedule template to this batch.</p>
                        </div>
                    </div>
                ...
                <section class="border-b border-slate-100 px-5 py-6 dark:border-slate-800">
                    <div class="mb-5 flex items-start gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-slate-950 dark:text-white">Trainer Information</h2>
                            <p class="text-sm text-slate-500 dark:text-slate-400">Assign a trainer and review possible schedule conflicts.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/60">
                            <div class="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    <p class="text-sm font-semibold text-slate-800 dark:text-slate-100">Existing Batches</p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400">Review trainer’s active schedule before saving.</p>
                                </div>
                                ...
                                <div class="rounded-2xl border p-4 transition
                                    ...
                                    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        ...
                                        <div class="sm:text-right">
                                            ...
                                            <p class="mt-1 text-xs text-rose-500 dark:text-rose-300">Overlapping schedule</p>
                                            @else
                ...
                <section class="px-5 py-6">
                    <div class="mb-5 flex items-start gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-slate-950 dark:text-white">Additional Information</h2>
                            <p class="text-sm text-slate-500 dark:text-slate-400">Optional notes or comments for this batch.</p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col gap-3 border-t border-slate-100 bg-slate-50 px-5 py-5 dark:border-slate-800 dark:bg-slate-800/40 sm:flex-row sm:items-center sm:justify-between">
                    <p class="text-xs text-slate-500 dark:text-slate-400">
                        Review all batch details carefully before saving.
                    </p>
                    ...
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center">
                        ...
                        <button
                            ...
                            <svg wire:loading.remove wire:target="saveTrainingBatch" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                            </svg>

                            <svg wire:loading wire:target="saveTrainingBatch" class="h-4 w-4 animate-spin" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path>
                            </svg>

                            <span wire:loading.remove wire:target="saveTrainingBatch">Create Training Batch</span>
                            <span wire:loading wire:target="saveTrainingBatch">Saving...</span>
                        </button>
                    </div>
                </div>
