            ...
            <div
                ...
                <div class="relative z-10 text-center lg:text-left">
                    ...
                    <p class="text-blue-100 leading-relaxed mb-8">
                        Forgot your password? No problem. Enter your registered email address and we'll send you a
                        secure link to reset it instantly.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            <div
                                class="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center text-xs font-bold text-white mt-0.5">
                                1</div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}" required
                                    autofocus autocomplete="email" placeholder="juan.tamad@gmail.com"
